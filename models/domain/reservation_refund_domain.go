...
import "sayamphoo/microservice/models/entity"

type ReserveRefundDomain struct {
	...
	TimestampCancel string             `json:"timestampCancel"`
	Refund          entity.BankAccount `json:"bankAccount"`
}
